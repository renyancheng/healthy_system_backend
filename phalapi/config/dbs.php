...
return array(
    ...
    'servers' => array(
        'db_master' => array(                       // 服务器标记 / database identify
            ...
            'name'      => isset($_ENV['PHALAPI_DB_NAME'])      ? $_ENV['PHALAPI_DB_NAME']      : 'healthy_system',               // 数据库名字 / database name
            ...
            'port'      => isset($_ENV['PHALAPI_DB_PORT'])      ? $_ENV['PHALAPI_DB_PORT']      : '3307',                  // 数据库端口 / database port
